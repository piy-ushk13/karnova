...
class DestinationsScreenRedesign extends ConsumerStatefulWidget {
  const DestinationsScreenRedesign({super.key});

  @override
  ConsumerState<DestinationsScreenRedesign> createState() =>
      _DestinationsScreenRedesignState();
}

class _DestinationsScreenRedesignState
    extends ConsumerState<DestinationsScreenRedesign> {
