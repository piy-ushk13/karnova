...
class StaysScreenAnimated extends ConsumerStatefulWidget {
  const StaysScreenAnimated({super.key});

  @override
  ConsumerState<StaysScreenAnimated> createState() => _StaysScreenAnimatedState();
}

class _StaysScreenAnimatedState extends ConsumerState<StaysScreenAnimated> {
